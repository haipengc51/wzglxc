...
public class MoveHistoryDetailActivity extends MyBaseActivity implements View.OnClickListener {
    @BindView(R.id.back)
    ImageView back;
    @BindView(R.id.title)
    TextView title;
    ...
    public void initView() {
        setContentView(R.layout.activity_move_history_detail);
    }
    ...
    public void initData() {
        ...
        currentDatas = (DevicemoveEntity) getIntent().getSerializableExtra(IntentFlag.DATA);
    }

    @Override
    public void initOperation() {
        if (currentDatas != null) {
            recordType.setText(CommonUtils.getDataIfNull(getResources().getString(R.string.device_move)));
    ...
    private void insertImagePath(String SBBH) {
        ...
        DBManager.dbDeal(DBManager.EVENT_UPDATA)
                ...
                .params(new String[]{romoteImageName, fileSize, imagePath, imageType, SBBH, Config.doc_sbzc})
                .execut(new DbCallBack() {
                    @Override
                    public void onDbStart() {
    ...
    private void deletRemotImage() {
        DBManager.dbDeal(DBManager.SELECT)
                ...
                .params(new String[]{String.valueOf(currentDatas.getID()), Config.doc_sbzc})
